...
namespace PizzaOrder.Migrations
{
    ...
    [Migration("20230511062447_addcolumnsinsliseshowimagetable")]
    partial class addcolumnsinsliseshowimagetable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaOrder.Models.ContactUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PizzaOrder.Models.Crust", b =>
                {
                    ...
                    b.HasIndex("Name", "CompanyId", "ItemSizeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("PizzaOrder.Models.DealSectionDetail", b =>
                {
                    ...
                    b.HasIndex("DealSectionId", "ItemId")
                        .IsUnique();
            ...
            modelBuilder.Entity("PizzaOrder.Models.ItemSize", b =>
                {
                    ...
                    b.HasIndex("SizeDescription", "ItemId")
                        .IsUnique();

                    b.ToTable("ItemSize");
                });

            modelBuilder.Entity("PizzaOrder.Models.ItemSizeTransection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PizzaOrder.Models.Order", b =>
                {
                    ...
                    b.HasOne("PizzaOrder.Models.User", "ObjUpdatedBy")
                        .WithMany()
